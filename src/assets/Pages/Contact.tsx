...
export const Contact = () => {
  return (
    <section
      className="flex flex-col justify-center items center h-screen min-h-screen"
      id="contact"
    >
      ...
      <div className="links flex flex-col items-center gap-y-5 lg:flex-row lg:justify-between">
        <a
          ...
          target="_blank"
          className="transition ease-in-out delay-150 hover:shadow-[0px_0px_116px_-25px_#3eb4f0]"
        >
        ...
        <a
          href="mailto:jose.payampsrosario@outlook.com"
          target="_blank"
          className="transition ease-in-out delay-150 hover:shadow-[0px_0px_116px_-25px_#3eb4f0]"
        >
          <div className="w-48 h-48 bg-darkmode-secondary flex justify-center items-center">
